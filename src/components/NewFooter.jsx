...
const NewFooter = ({ onLetsTalkClick }) => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-neutral-800 pb-8 mb-8">
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
              <img className="h-8 w-8 object-contain" src="/aisk.png" alt="AI Swiss Knife Logo" />
          ...
          <div className="flex space-x-8">
            <a href="#case-studies" className="text-neutral-300 hover:text-white transition-colors duration-250">
              {t('nav.caseStudies')}
            </a>
            <a href="#about" className="text-neutral-300 hover:text-white transition-colors duration-250">
              {t('nav.about')}
            </a>
            <button onClick={onLetsTalkClick} className="text-neutral-300 hover:text-white transition-colors duration-250">
              {t('footer.contact')}
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <a
              href="https://twitter.com/AiSwissKnife"
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-400 hover:text-white transition-colors duration-250"
